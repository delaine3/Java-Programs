...
class Roads {
  ...
  void displayRoad() {
    ...
    for (int i = 0; i<5; i++) {
      image(lRroad, 0 + i*45, 320, width/10, height/10);
    }
    for (int i = 0; i<11; i++) {
    ...
    for (int i = 0; i<11.5; i++) {
      image(vRoad, 300, 0 + i*49, width/13, height/5);
    }
    
    //road on the right side of houses
    for (int i = 0; i<20; i++) {
      image(vRoad, 795, 0 + i*28.5, width/15, height/5);
    }
    
        //road just above houses
    for (int i = 0; i<6; i++) {
      image(lRroad, 388 + i*58, 400, width/10, height/10);
    }
  }
}
